...
Blockly.Msg.LOOKS_GETWHATBUBBLEISDISPLAYING = 'current text displayed in bubble';
Blockly.Msg.LOOKS_SETFONT = 'set font to %1 with font size %2';
Blockly.Msg.LOOKS_SETCOLOR = 'set %1 color to %2';
Blockly.Msg.LOOKS_SETCOLOR_BORDER = 'border';
Blockly.Msg.LOOKS_SETCOLOR_FILL = 'fill';
Blockly.Msg.LOOKS_SETCOLOR_TEXT = 'text';
Blockly.Msg.LOOKS_SETSHAPE = 'set text bubble %1 to %2';
Blockly.Msg.LOOKS_SETSHAPE_MINIMUMWIDTH = 'minimum width';
Blockly.Msg.LOOKS_SETSHAPE_MAXIMUMWIDTH = 'maximum width';
Blockly.Msg.LOOKS_SAYHEIGHT = 'bubble height';
Blockly.Msg.LOOKS_SAYWIDTH = 'bubble width';
...
Blockly.Msg.LOOKS_EFFECT_SATURATION = 'saturation';
...
Blockly.Msg.LOOKS_GETEFFECTVALUE = '%1 effect';
Blockly.Msg.LOOKS_SETTINTCOLOR = 'set tint color to %1';
Blockly.Msg.LOOKS_TINTCOLOR = 'tint color';
...
Blockly.Msg.LOOKS_CHANGESTRETCH = 'change stretch by x: %1 y: %2';
Blockly.Msg.LOOKS_SETSTRETCH = 'set stretch to x: %1 y: %2';
Blockly.Msg.LOOKS_STRETCHGETX = 'x stretch';
Blockly.Msg.LOOKS_STRETCHGETY = 'y stretch';
...
Blockly.Msg.LOOKS_NEXTCOSTUME_MENU = 'next costume';
Blockly.Msg.LOOKS_PREVIOUSCOSTUME_MENU = 'previous costume';
Blockly.Msg.LOOKS_RANDOMCOSTUME_MENU = 'random costume';
...
Blockly.Msg.LOOKS_GOTARGETLAYER = 'go %1 %2';
